...
pub async fn get_commodity_history(
    ...
    let price_history: Result<Vec<HistoricPrice>> = history
        .quotes()
...
pub fn write_pricesdb_file(filename: PathBuf, prices_history: Vec<HistoricPrice>) -> Result<()> {
